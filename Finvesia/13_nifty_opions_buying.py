...
my_information = {
                    'NFO:NIFTY15JUN23C18900':'NFO|55412',
                    'NFO:NIFTY15JUN23P18900':'NFO|55413',

                    'NFO:NIFTY15JUN23C18850':'NFO|55400',
                    'NFO:NIFTY15JUN23P18850':'NFO|55404',

                    'NFO:NIFTY15JUN23C18800':'NFO|55389',
                    'NFO:NIFTY15JUN23P18800':'NFO|55392',
                            
                    'NFO:NIFTY15JUN23C18750':'NFO|55387',
                    'NFO:NIFTY15JUN23P18750':'NFO|55388',

                    'NFO:NIFTY15JUN23C18700':'NFO|55374',
                    'NFO:NIFTY15JUN23P18700':'NFO|55382',
#-----------------------------15--------------------------------------
                    'NFO:NIFTY15JUN23C18650':'NFO|55372',
                    'NFO:NIFTY15JUN23P18650':'NFO|55373',
                              
                    'NFO:NIFTY15JUN23C18600':'NFO|55369',
                    'NFO:NIFTY15JUN23P18600':'NFO|55371',
                              
                    'NFO:NIFTY15JUN23C18550':'NFO|55356',
                    'NFO:NIFTY15JUN23P18550':'NFO|55357',
                              
                    'NFO:NIFTY15JUN23C18500':'NFO|55331',
                    'NFO:NIFTY15JUN23P18500':'NFO|55332',
                              

                    'NFO:NIFTY15JUN23C18450':'NFO|55323',
                    'NFO:NIFTY15JUN23P18450':'NFO|55324',

                    'NFO:NIFTY15JUN23C18400':'NFO|55316',
                    'NFO:NIFTY15JUN23P18400':'NFO|55318',
...
def getLTP_websocket(exch,token):
    ...
    if resp is not None:
        ...
        print("NOT ABLE TO GET LTP")
        sleep(3)
        getLTP_websocket(exch, token)
...
def exit_half():
    print(" exit_half() ")
    global previous_quantity, previous_symbol, entry_price, last_postion,fst_target, sl_target, loop,fst_target,loop

    place_target_after = entry_price + (entry_price * 0.05)
    place_sl_after = entry_price - (entry_price * 0.05)
    ...
    while loop :
        if last_postion == "FULL" and previous_symbol is not None and previous_quantity is not None:
            try:
                ...
                try:
                    if ltp >= fst_target:
                        order_id = placeOrder(previous_symbol, "SELL", (float(previous_quantity) / 2), 0, "MARKET")
                ...
                try:
                    if ltp <= sl_target:
                        order_id = placeOrder(previous_symbol, "SELL", float(previous_quantity), 0, "MARKET")
                        status = get_status_of_order_for_exit_quantity(order_id)
                        if status == "COMPLETED":
                            previous_quantity = None
                            previous_symbol = None
...
def exit_order(symbol, message):
    ...
    if previous_symbol != None:
        ...
        elif symbol in previous_symbol and 'P' in previous_symbol and 'P_SELL' in message:
            order_id = placeOrder(previous_symbol, "SELL", previous_quantity, 0,"MARKET")
            return get_status_of_order(order_id)
    else:
        print("PREVIOUS TRADE IS NOT ACTIVE : NO SELL ORDER")
        return "PREVIOUS TRADE IS NOT ACTIVE : NO SELL ORDER"
...
def entry_order(symbol, message):
    ...
    if "C_BUY" in message:
            if "C_BUY" in buy_or_sell_flag:
                ...
                return string1
            raise Exception("CE :: BUYING IS NOT THERE IN THE FLAG")
    if  "P_BUY" in message:
